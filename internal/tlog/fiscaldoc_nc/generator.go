...
// Generator implementa tlog.Generator para InventoryFiscalDoc (NC).
...
func writeNCDoc(x *common.XMLBuilder, h *common.HeaderCtx, retailID, seqNum string,
	...
	x.Element("ICDAmount", common.FormatDecimal4(brutto)) // negativo para NC
...
func writeNCLine(x *common.XMLBuilder, s *db.Store, line db.Row, detSeq int) {
