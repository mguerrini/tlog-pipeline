...
const (
	...
	Period                     = "0"
	Subperiod                  = "0"
	DocumentTypeCode           = "InventoryAdjustment"
...
// Generator implementa tlog.Generator para InventoryAdjustment.
type Generator struct{}

func (Generator) Type() naming.TLOGType { return naming.TLOGAdjustment }
...
func writeAdjustmentDoc(x *common.XMLBuilder, h *common.HeaderCtx, retailID, seqNum string,
	...
	for i, line := range lines {
		writeAdjustmentLine(x, s, line, i+1)
	}
	x.Close()
	x.Close()
	x.Close()
...
func writeAdjustmentLine(x *common.XMLBuilder, s *db.Store, line db.Row, detSeq int) {
